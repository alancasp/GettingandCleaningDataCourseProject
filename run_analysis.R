...
X_test <- read.table("./UCI HAR Dataset/test/X_test.txt", colClasses = "character")
...
subject_test <- read.table("./UCI HAR Dataset/test/subject_test.txt", colClasses = "character")
...
X_train <- read.table("./UCI HAR Dataset/train/X_train.txt", colClasses = "character")
...
subject_train <- read.table("./UCI HAR Dataset/train/subject_train.txt", colClasses = "character")
